...
ENV JVM_OPTS="-Xmx192M -Xms192M -Xmn64M -Xloggc:/logFile/gc.log -XX:+ParallelRefProcEnabled -XX:ErrorFile=/logFile/hs_err_pid%p.log -XX:HeapDumpPath=/logFile -XX:+PrintGCDetails -XX:+PrintGCDateStamps -XX:+HeapDumpOnOutOfMemoryError -XX:+PrintClassHistogramBeforeFullGC -XX:+PrintClassHistogramAfterFullGC -XX:+PrintGCApplicationConcurrentTime -XX:+PrintGCApplicationStoppedTime -XX:+PrintTenuringDistribution -XX:+PrintHeapAtGC -XX:MaxMetaspaceSize=0M -XX:MetaspaceSize=0M -XX:+UseParallelGC -XX:+UseAdaptiveSizePolicy -XX:MaxGCPauseMillis=100"
