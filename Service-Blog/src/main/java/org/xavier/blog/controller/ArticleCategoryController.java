...
import org.xavier.blog.service.impl.ArticleCategoryServiceImpl;
...
public class ArticleCategoryController extends HyggeWriterController {
    ...
    public ResponseEntity<?> saveArticleCategoryTreeInfo(@RequestBody String articleCategoryTreeInfo) {
    ...
    public ResponseEntity<?> quarryAllArticleCategory() {
        User loginUser = RequestProcessTrace.getContext().getCurrentLoginUser();
        try {
            userService.checkRight(loginUser, UserTypeEnum.ROOT);
